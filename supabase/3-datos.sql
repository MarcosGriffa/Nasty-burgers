...
insert into public.grupos_modificadores (nombre, productos, minimo, maximo) values
  ('Bebida', 4, 0, 1),
  ('Extras', 5, 0, 4),
  ('Papas fritas S o N', 2, 1, 1),
  ('Papas Fritas S o N Promo', 2, 4, 4),
  ('Promo 2x1', 7, 1, 2),
  ('Promo 3x4 Dobles', 8, 4, 4),
  ('Promo 3x4 Simples', 8, 4, 4),
  ('Promo 4x3 Triples', 8, 4, 4);
